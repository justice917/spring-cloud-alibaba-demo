...
import com.boot.create.MyBootApplicationFeignProvider;
import com.boot.create.mysql.template.entity.UserTest;
import com.boot.create.mysql.template.service.IUserTestService;


@RunWith(SpringRunner.class)
@SpringBootTest(classes = MyBootApplicationFeignProvider.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
